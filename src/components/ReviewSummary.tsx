...
interface DistributionBarProps {
  star: number;
  distributionBars: SharedValue<Record<number, number>>;
}
...
const DistributionBar: React.FC<DistributionBarProps> = ({ star, distributionBars }) => {
  const barStyle = useAnimatedStyle(() => {
    return {
      width: `${(distributionBars.value[star] || 0) * 100}%`,
      backgroundColor: getStarColor(star),
    };
  });

  return <Animated.View style={[styles.distributionBar, barStyle]} />;
};
          ...
          return (
            ...
            >
              ...
              <View style={styles.distributionBarContainer}>
                <DistributionBar star={star} distributionBars={distributionBars} />
              </View>
