...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 820 para garantir que estamos longe de problemas passados (como 804/805)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 820);
