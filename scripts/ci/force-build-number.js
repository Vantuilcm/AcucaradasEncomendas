...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 907 para garantir que estamos longe de problemas passados (como 906)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 907);
