...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 800 para garantir que estamos longe de problemas passados (como 784)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 800);
