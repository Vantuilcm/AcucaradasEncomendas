      ...
      <Animated.View entering={FadeIn.duration(400)}>
        ...
        <View style={styles.secao}>
          ...
          >
            ...
            >
              <Text style={[styles.botaoTexto, permissaoMicrofone && styles.botaoTextoDesativado]}>
                {permissaoMicrofone ? 'Concedido' : 'Conceder'}
              </Text>
            </TouchableOpacity>
          </Animated.View>
