...
export function ReportsScreen() {
  ...
  const handleExportReport = async () => {
    try {
      ...
      destinationFile.write(csvContent, { encoding: 'utf8' });
      ...
      logger.error('Erro ao exportar relatório:', error instanceof Error ? error : new Error(String(error)));
  ...
  return (
    <ProtectedRoute
      requiredPermissions={[Permission.VISUALIZAR_RELATORIOS]}
