...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 840 para garantir que estamos longe de problemas passados (como 828)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 840);
