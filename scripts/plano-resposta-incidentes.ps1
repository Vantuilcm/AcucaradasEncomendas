            ...
            IncidentResponse = @{
                Team = @(
                    @{
                        ...
                        Email = "coordenador@acucaradasencomendas.com.br"
                        Phone = "(11) 98765-4321"
                        Responsibilities = @(
                    ...
                    @{
                        ...
                        Email = "analista@acucaradasencomendas.com.br"
                        Phone = "(11) 98765-4322"
                        Responsibilities = @(
                    ...
                    @{
                        ...
                        Email = "sysadmin@acucaradasencomendas.com.br"
                        Phone = "(11) 98765-4323"
                        Responsibilities = @(
                    ...
                    @{
                        ...
                        Email = "comunicacao@acucaradasencomendas.com.br"
                        Phone = "(11) 98765-4324"
                        Responsibilities = @(
                    ...
                    @{
                        ...
                        Email = "juridico@acucaradasencomendas.com.br"
                        Phone = "(11) 98765-4325"
                        Responsibilities = @(
...
function Start-IncidentSimulation {
    ...
    $affectedSystems = @("sistema-web.acucaradasencomendas.com.br", "api.acucaradasencomendas.com.br")
