        ...
        $monitoringConfigContent = @"
{
  "monitoring": {
    ...
    "notificationChannels": [
      {
        "type": "email",
        "recipients": ["seguranca@acucaradas.com"],
        "onlyAlerts": true
      },
      {
        "type": "slack",
...
1. **Envie um e-mail para** [seguranca@acucaradas.com](mailto:seguranca@acucaradas.com) com o assunto "Relatório de Vulnerabilidade: [Breve Descrição]"
...
- API em api.acucaradas.com
- Site principal em www.acucaradas.com
...
<body>
    ...
    <main class="bounty-container">
        ...
        <div class="bounty-card">
            ...
            <ol>
                ...
                <li>Envie um relatório detalhado para <a href="mailto:seguranca@acucaradas.com">seguranca@acucaradas.com</a></li>
        ...
        <div class="bounty-card">
            ...
            <ul>
                ...
                <li>API em api.acucaradas.com</li>
                <li>Site principal em www.acucaradas.com</li>
            </ul>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>Contato</h3>
                <p>Email: contato@acucaradas.com</p>
...
|--------|------------------|--------|
| Coordenador de Incidentes | Coordenar a resposta geral, comunicação com stakeholders | coordenador@acucaradas.com |
| Analista de Segurança | Investigação técnica, análise forense | seguranca@acucaradas.com |
| Administrador de Sistemas | Restauração de sistemas, implementação de correções | sistemas@acucaradas.com |
| Comunicação | Comunicação com usuários, mídia e autoridades | comunicacao@acucaradas.com |
| Jurídico | Conformidade legal, notificações obrigatórias | juridico@acucaradas.com |
...
Para mais informações, entre em contato conosco pelo e-mail seguranca@acucaradas.com ou pelo telefone [número].
