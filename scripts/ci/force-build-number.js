...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 895 para garantir que estamos longe de problemas passados (como 894)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 895);
