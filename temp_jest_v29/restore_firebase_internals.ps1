...
# Missing Firebase Internals
Install-Package "@firebase/component" "0.6.4"
Install-Package "@firebase/logger" "0.4.0"
Install-Package "idb" "7.1.1"
Install-Package "tslib" "2.6.2" # Latest tslib usually safe, checking package.json suggested ^2.1.0

Write-Host "ALL DONE - Firebase Internals Restored"
