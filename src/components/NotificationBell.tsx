...
const NotificationBell: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const notificationListener = ExpoNotifications.addNotificationReceivedListener(_notification => {
      loadNotifications();
    });
  ...
  const loadNotifications = async () => {
    ...
    const unread = userNotifications.filter((notification: AppNotification) => !notification.read)
      .length;
