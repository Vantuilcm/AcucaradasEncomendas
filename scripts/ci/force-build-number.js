...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 865 para garantir que estamos longe de problemas passados (como 863)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 865);
