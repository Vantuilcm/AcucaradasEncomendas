...
export const Toast = ({
  ...
  const getTypeStyles = (): { backgroundColor: string; icon: IoniconName } => {
    switch (type) {
      ...
      default:
        // Fallback para garantir retorno em todos os caminhos
        return {
          backgroundColor: theme.colors.primary,
          icon: 'information-circle',
        };
  ...
  useEffect(() => {
    ...
    // Garantir que sempre retornamos uma função de limpeza
    return () => {};
