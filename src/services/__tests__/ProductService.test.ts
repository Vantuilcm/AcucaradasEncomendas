...
describe('ProductService', () => {
  ...
  describe('criarProduto', () => {
    it('deve criar um produto com sucesso', async () => {
      ...
      expect(resultado.imagens).toEqual(dadosProduto.imagens);
    });
  ...
  describe('consultarProduto', () => {
    it('deve consultar um produto existente', async () => {
      const idProduto = 'prod1';
      const resultado = await productService.consultarProduto(idProduto);
      expect(resultado).toBeDefined();
      expect(resultado.id).toBe(idProduto);
      expect(resultado.nome).toBe('Bolo de Chocolate Belga');
      expect(resultado.preco).toBe(45);
    });
  ...
  describe('atualizarProduto', () => {
    it('deve atualizar um produto com sucesso', async () => {
      ...
      const dadosAtualizacao = {
        ...
        categoria: 'Bolos',
        disponivel: true,
        imagens: ['bolo-chocolate-premium.jpg'],
      };
      ...
      expect(resultado.imagens).toEqual(dadosAtualizacao.imagens);
    });
