...
function sendSecurityAlert(alert) {
  // Implementação de exemplo - aqui você conectaria com seu sistema de alertas
  console.log('ALERTA DE SEGURANÇA:', JSON.stringify(alert, null, 2));
  
  // Exemplo: enviar para webhook
  // fetch('https://seu-webhook.exemplo/alerts', {
  //   method: 'POST',
