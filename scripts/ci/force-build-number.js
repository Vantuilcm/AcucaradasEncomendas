...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 874 para garantir que estamos longe de problemas passados (como 872)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 874);
