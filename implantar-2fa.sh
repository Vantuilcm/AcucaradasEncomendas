...
firebase use acucaradas-encomendas

echo ""
echo "3. Configurando variáveis de ambiente para e-mail..."
firebase functions:config:set email.user="notificacao@acucaradas.com.br" email.password="app-senha-segura-123" email.sender="notificacao@acucaradas.com.br"
