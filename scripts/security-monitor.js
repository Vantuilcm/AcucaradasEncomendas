...
const CONFIG = {
  ...
  alerts: {
    email: {
      ...
      auth: {
        user: process.env.EMAIL_USER || 'security@acucaradas.com',
        pass: process.env.EMAIL_PASS || 'your-password'
      },
      from: process.env.EMAIL_FROM || 'security@acucaradas.com',
      to: (process.env.EMAIL_TO || 'admin@acucaradas.com').split(',')
    },
    slack: {
