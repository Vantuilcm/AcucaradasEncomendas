...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 870 para garantir que estamos longe de problemas passados (como 869)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 870);
