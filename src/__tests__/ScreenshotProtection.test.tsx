...
describe('ScreenshotProtection Component', () => {
  ...
  it('deve ativar a proteÃ§Ã£o contra capturas de tela ao montar', async () => {
    render(
  ...
  it('nÃ£o deve ativar a proteÃ§Ã£o se enabled=false', async () => {
    render(
  ...
  it('deve registrar log quando uma captura de tela Ã© detectada', async () => {
    render(
    ...
    expect(loggingService.warn).toHaveBeenCalledWith(
      'Captura de tela detectada em conteÃºdo protegido',
  ...
  it('deve chamar onScreenshotDetected quando uma captura Ã© detectada', async () => {
  ...
  it('deve enviar relatÃ³rio ao servidor quando reportToServer=true', async () => {
    render(
    ...
    // Verificar se fetch foi chamado para enviar o relatÃ³rio
  ...
  it('deve desativar a proteÃ§Ã£o quando o app vai para background e reativar quando volta', async () => {
    render(
      <ScreenshotProtection>
        <></>
      </ScreenshotProtection>
    ...
    // Verificar que a proteÃ§Ã£o foi ativada inicialmente
    ...
    // Verificar que a proteÃ§Ã£o foi desativada
    ...
    // Verificar que a proteÃ§Ã£o foi reativada
    expect(ScreenCapture.preventScreenCaptureAsync).toHaveBeenCalledTimes(2);
  });
  
  it('deve lidar corretamente com erros ao ativar a proteÃ§Ã£o', async () => {
    // Simular um erro ao ativar a proteÃ§Ã£o
    (ScreenCapture.preventScreenCaptureAsync as jest.Mock).mockRejectedValueOnce(new Error('Erro ao ativar proteÃ§Ã£o'));
    ...
    // Aguardar a rejeiÃ§Ã£o da Promise
    await waitFor(() => {
      expect(loggingService.error).toHaveBeenCalledWith(
        expect.stringContaining('Erro ao ativar proteÃ§Ã£o contra capturas de tela'),
        expect.objectContaining({
  ...
  it('deve enviar relatÃ³rio para o servidor quando reportToServer=true', async () => {
    render(
      <ScreenshotProtection reportToServer={true}>
        <></>
      </ScreenshotProtection>
  ...
  it('deve lidar com erros na API de captura de tela', async () => {
    ...
    await waitFor(() => {
      expect(loggingService.error).toHaveBeenCalledWith(
        'Erro ao ativar proteÃ§Ã£o contra capturas de tela',
        expect.objectContaining({
