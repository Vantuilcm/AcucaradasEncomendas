...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 882 para garantir que estamos longe de problemas passados (como 881)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 882);
