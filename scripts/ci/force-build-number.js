...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 888 para garantir que estamos longe de problemas passados (como 886)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 888);
