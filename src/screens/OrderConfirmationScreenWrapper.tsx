...
/**
 * Wrapper para OrderConfirmationScreen que adiciona os links para documentos legais
 */
export default function OrderConfirmationScreenWrapper(props: any) {
  return (
    <View style={styles.container}>
      {/* Renderiza a OrderConfirmationScreen original */}
      <OrderConfirmationScreen {...props} />
