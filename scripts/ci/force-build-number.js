...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 898 para garantir que estamos longe de problemas passados (como 897)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 898);
