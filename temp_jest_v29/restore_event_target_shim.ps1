...
# Restore missing event-target-shim dependency for abort-controller
Install-Package "event-target-shim" "5.0.1"

Write-Host "ALL DONE - Event Target Shim Restored"
