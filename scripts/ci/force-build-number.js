...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 860 para garantir que estamos longe de problemas passados (como 856)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 860);
