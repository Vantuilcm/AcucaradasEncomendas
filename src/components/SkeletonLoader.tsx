...
export const SkeletonLoader = ({
  ...
  const shimmerRange = typeof width === 'number' ? width : 200;
  const shimmerTranslate = shimmerValue.interpolate({
    inputRange: [0, 1],
    outputRange: [-shimmerRange, shimmerRange],
  });
...
export const ProductCardSkeleton = ({
  ...
  const numericHeight = typeof height === 'number' ? height : 240;
  return (
    <View style={[styles.productCard, { width: numericWidth, height: numericHeight }, style]}>
      {/* Imagem */}
