...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 892 para garantir que estamos longe de problemas passados (como 890)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 892);
