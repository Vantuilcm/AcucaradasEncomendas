 ...
 * @returns {Object} Objeto contendo a chave secreta
 */
...
/**
 * Gera um QR code para configuração de autenticação de dois fatores
 * @param {string} secret - Chave secreta em formato otpauth_url
 * @returns {Promise<string>} URL de dados do QR code
 */
