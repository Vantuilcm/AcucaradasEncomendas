...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 1221 para garantir que o proximo seja 1222 para validacao da correcao do firebase
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 1221);
