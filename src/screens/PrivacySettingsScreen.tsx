...
export function PrivacySettingsScreen() {
  ...
  useEffect(() => {
    try {
      ...
      console.error('Erro ao iniciar carregamento de configurações de privacidade:', error);
    }
  }, []);
  ...
  const loadSettings = async () => {
    try {
      ...
      const settingsData = await privacyService.getUserPrivacySettings(userId);
  ...
  const handleReset = async () => {
    try {
      ...
      setError(null);
      const privacyService = new PrivacySettingsService();
      await privacyService.resetPrivacySettings(userId);
      await loadSettings();
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme?.colors?.background || '#FFFFFF' }]}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.content}>
          <Text variant="titleLarge" style={[styles.title, { color: theme?.colors?.text?.primary || '#000000' }]}>
            Configurações de Privacidade
          </Text>

          <Text variant="bodyMedium" style={[styles.description, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            Gerencie suas preferências de privacidade e controle como suas informações são exibidas
            e utilizadas.
          </Text>

          <View style={styles.section}>
            <Text variant="titleMedium" style={[styles.sectionTitle, { color: theme?.colors?.text?.primary || '#000000' }]}>
              Visibilidade do Perfil
            </Text>
            <Text variant="bodySmall" style={[styles.sectionDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
              Controle quais informações do seu perfil são visíveis para outros usuários
            </Text>

            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Perfil Público</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Histórico de Pedidos</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Avaliações</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Endereços</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Métodos de Pagamento</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Notificações</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Localização</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Analytics</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
            ...
            <View style={[styles.setting, { borderBottomColor: theme?.colors?.border || '#E0E0E0' }]}>
              <View style={styles.settingInfo}>
                <Text variant="bodyLarge" style={{ color: theme?.colors?.text?.primary || '#000000' }}>Marketing</Text>
                <Text variant="bodySmall" style={[styles.settingDescription, { color: theme?.colors?.text?.secondary || '#757575' }]}>
