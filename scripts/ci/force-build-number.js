...
class BuildNumberEnforcer {
  ...
  enforce() {
    ...
    // Adicionado floor de 850 para garantir que estamos longe de problemas passados (como 843/845)
    const baseline = Math.max(currentLocal, appleLatest, historyLatest, 850);
