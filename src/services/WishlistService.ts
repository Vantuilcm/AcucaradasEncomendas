...
export class WishlistService {
  ...
  public async getWishlistByUserId(userId: string): Promise<Wishlist | null> {
    try {
      ...
      logger.error('Erro ao buscar lista de desejos', { userId, error });
      return null;
    }
  }
  ...
  public async addToWishlist(userId: string, productId: string): Promise<boolean> {
    try {
      ...
      logger.error('Erro ao adicionar produto à lista de desejos', { userId, productId, error });
      return false;
    }
  }
  ...
  public async removeFromWishlist(userId: string, productId: string): Promise<boolean> {
    try {
      ...
      logger.error('Erro ao remover produto da lista de desejos', { userId, productId, error });
      return false;
    }
  }
  ...
  public async isInWishlist(userId: string, productId: string): Promise<boolean> {
    try {
      ...
      logger.error('Erro ao verificar produto na lista de desejos', { userId, productId, error });
      return false;
    }
  }
  ...
  public async updateWishlistPrivacy(userId: string, isPublic: boolean): Promise<boolean> {
    try {
      ...
      logger.error('Erro ao atualizar privacidade da lista de desejos', { userId, isPublic, error });
      return false;
    }
  }
  ...
  public async getWishlistProducts(userId: string): Promise<Product[]> {
    try {
      ...
      logger.error('Erro ao obter produtos da lista de desejos', { userId, error });
      return [];
    }
  }
}
